  ...
  return (
    <Modal {...props}>
      ...
      >
        ...
        >
          {`코어 창업에서 제공하는 서비스(https://www.core-point.kr/)는 정보주체의 자유와 권리 보호를 위해 「개인정보 보호법」 및 관계 법령이 정한 바를 준수하여, 적법하게 개인정보를 처리하고 안전하게 관리하고 있습니다. 
...
창업 컨설팅 신청 - 이름, 휴대폰번호, 문의내용, 문의 회신 수집일로부터 3년

양도 컨설팅 신청 - 이름, 휴대폰번호, 문의내용, 문의 회신 수집일로부터 3년

협업 신청 - 브랜드명, 이름, 휴대폰번호, 문의내용, 문의 회신 수집일로부터 3년

매물정보 -  매물정보에 대한 모든 내용 수집일로부터 3년
...
② 어뷰징으로 인해 코어창업에게 손해를 발생시키거나, 어뷰징 자체가 관련법 또는 코어창업 홍보지침을 위반하는 경우, 
   코어창업은 해당 사용자를 대상으로 민, 형사상의 법적 조치를 취할 수 있으며 어뷰징 유저는 이에 대한 모든 책임을 진다.

③ 코어창업은 법령에 따른 개인정보 보유∙이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의 받은 개인정보 보유∙이용기간 내에서 개인정보를 처리∙보유합니다. 다만, 
    다음의 사유에 해당하는 경우에는 해당 사유 종료시까지 처리∙보유합니다. - 관계 법령 위반에 따른 수사∙조사 등이 진행 중인 경우에는 해당 수사∙조사 종료 시까지


개인정보의 파기

① 코어 창업은 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.

② 정보주체로부터 동의받은 개인정보 보유기간이 경과하거나 처리목적이 달성되었음에도 불구하고 다른 법령에 따라 개인정보를 계속 보존하여야 하는 경우에는, 해당 개인정보를 별도의 데이터베이스(DB)로 옮기거나 보관장소를 달리하여 보존합니다.

③ 개인정보 파기의 절차 및 방법은 다음과 같습니다.

    코어 창업은 파기 사유가 발생한 개인정보를 선정하고, 창업이지의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
...
② 제1항에 따른 권리 행사는 코어창업에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편 등을 통하여 하실 수 있으며 창업이지는 이에 대해 지체 없이 조치하겠습니다.
...
⑥ 코어창업 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.
...
전산실, 자료보관 프로그램 등의 지정된 책임자 외 접근통제
...
② 정보주체는 코어창업의 서비스을 이용하시면서 발생한 모든 개인정보보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의할 수 있습니다. 
